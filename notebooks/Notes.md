...
# Train msgnn
CUDA_VISIBLE_DEVICES=0 python gns/multi_scale/train_multi_scale.py --mode=train --data_path=./datasets/taylor_impact_2d/onecase_data_processed/ --model_path=./models/Taylor_impact_2d/ --output_path=./rollouts/Taylor_impact_2d/ --input_sequence_length=6 --radius_multiplier=3 --batch_size=32 --noise_std=0.02 --layers=10 --hidden_dim=128 --lr_init=0.001 --ntraining_steps=200000 --lr_decay_steps=10000 --dim=2 --project_name=Taylor_impact_2d_OneCase --run_name=OneCase_Seq11_RM3_NS0.02_L10_N128 --nsave_steps=2000 -log=True

# Rollout
# Train
CUDA_VISIBLE_DEVICES=0 python gns/train.py --mode=rollout --data_path=./datasets/taylor_impact_2d/data_processed/ --model_path=./models/Taylor_impact_2d/Seq6_R1.2_NS0.02_L10_N128/ --model_file=model-020000.pt --output_path=./rollouts/Taylor_impact_2d/ --input_sequence_length=6 --connection_radius=1.2 --noise_std=0.02 --layers=10 --hidden_dim=128 --dim=2 --project_name=Taylor_impact_2d --run_name=Seq6_R1.2_NS0.02_L10_N128
# msgnn
CUDA_VISIBLE_DEVICES=0 python gns/multi_scale/train_multi_scale.py --mode=rollout --data_path=./datasets/taylor_impact_2d/onecase_data_processed/ --model_path=./models/Taylor_impact_2d/OneCase_Seq11_RM3_NS0.02_L10_N128/ --model_file=model-020000.pt --output_path=./rollouts/Taylor_impact_2d/ --input_sequence_length=11 --radius_multiplier=2 --noise_std=0.02 --layers=10 --hidden_dim=128 --dim=2 --project_name=Taylor_impact_2d --run_name=OneCase_Seq11_RM3_NS0.02_L10_N128

# Visualisation
python -m gns.render_rollout --rollout_path=rollouts/MS_default/ --output_path=rollouts/MS_default/ --batch_mode=True
